...
|-|:---|:---|:---|:---|:---|
| CT-01: Verificar o funcionamento da autenticação e perfis de usuário. | RF-01 A aplicação deve disponibilizar uma forma de autenticação e perfis de usuário. | Verificar se o usuário pode-se inscrever nos projetos publicados| 1 - Clicar em perfil. | O perfil deve mostrar os dados cadastrados pelo usuário. | Arthur |
